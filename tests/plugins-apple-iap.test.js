...
test.skip('Plugins: Apple IAP', () => {
  ...
  test.before(async () => {
    ...
    // Add a iap provider (payment providers are now in the store)
  ...
  test.describe('Mutation.registerPaymentCredentials (Apple IAP)', () => {
    test('store the receipt as payment credentials', async () => {
    ...
    test('checking out again with the same transaction should fail', async () => {
      const { errors } = await graphqlFetch({
        query: /* GraphQL */ `
  ...
  test.describe('Apple Store Server Notifications', () => {
