...
## Patch
- User role changes and deletion now prevent removing the sole active administrator. GraphQL reports a typed `LastAdminError`, and Admin UI explains that another active user must be promoted before the sole administrator can be removed or demoted.
