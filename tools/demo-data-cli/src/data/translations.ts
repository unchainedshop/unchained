...
export const categoryTranslations: Record<string, Record<string, CategoryTranslation>> = {
  ...
  'electronics-store': {
    en: {
      ...
      description: 'Shop the latest electronics and tech gadgets',
    },
    de: {
      title: 'Elektronik Shop',
      slug: 'elektronik-shop',
      description: 'Die neuesten Elektronik- und Technik-Gadgets kaufen',
    },
    fr: {
      title: 'Boutique Electronique',
      slug: 'boutique-electronique',
      description: 'Achetez les derniers gadgets electroniques',
    },
  },
  ...
  'computers-laptops': {
    en: {
      ...
      description: 'Desktop computers and portable laptops for work and play',
    },
    de: {
      title: 'Computer & Laptops',
      slug: 'computer-laptops',
      description: 'Desktop-Computer und tragbare Laptops fuer Arbeit und Freizeit',
    },
    fr: {
      title: 'Ordinateurs & Portables',
      slug: 'ordinateurs-portables',
      description: 'Ordinateurs de bureau et portables pour le travail et les loisirs',
    },
  },
  laptops: {
    ...
    fr: {
      title: 'Ordinateurs Portables',
      slug: 'ordinateurs-portables',
      description: 'Puissance informatique portable pour tous les besoins',
    },
  },
  'gaming-laptops': {
    en: {
    ...
    de: {
      title: 'Gaming Laptops',
      slug: 'gaming-laptops',
      description: 'Hochleistungs-Laptops fuer ernsthafte Gamer',
    },
    fr: {
      title: 'Portables Gaming',
      slug: 'portables-gaming',
      description: 'Portables haute performance pour les gamers serieux',
    },
  },
  'business-laptops': {
    en: {
      ...
      description: 'Professional laptops for enterprise and productivity',
    },
    de: {
      title: 'Business Laptops',
      slug: 'business-laptops',
      description: 'Professionelle Laptops fuer Unternehmen und Produktivitaet',
    },
    fr: {
      title: 'Portables Professionnels',
      slug: 'portables-professionnels',
      description: 'Portables professionnels pour entreprise et productivite',
    },
  },
  ultrabooks: {
    en: {
      title: 'Ultrabooks',
      slug: 'ultrabooks',
      description: 'Ultra-thin and lightweight laptops for mobility',
    },
    de: {
      title: 'Ultrabooks',
      slug: 'ultrabooks',
      description: 'Ultraduenne und leichte Laptops fuer Mobilitaet',
    },
    fr: {
      title: 'Ultrabooks',
      slug: 'ultrabooks',
      description: 'Portables ultra-fins et legers pour la mobilite',
    },
  },
  'workstation-laptops': {
    en: {
      ...
      description: 'Powerful mobile workstations for professionals',
    },
    de: {
      title: 'Workstation Laptops',
      slug: 'workstation-laptops',
      description: 'Leistungsstarke mobile Workstations fuer Profis',
    },
    fr: {
      title: 'Portables Workstation',
      slug: 'portables-workstation',
      description: 'Stations de travail mobiles puissantes pour professionnels',
    },
  },
  'budget-laptops': {
    en: {
      ...
      slug: 'budget-laptops',
      description: 'Affordable laptops without compromise',
    },
    de: {
      title: 'Guenstige Laptops',
      slug: 'guenstige-laptops',
      description: 'Erschwingliche Laptops ohne Kompromisse',
    },
    fr: {
      title: 'Portables Budget',
      slug: 'portables-budget',
      description: 'Portables abordables sans compromis',
    },
  },
  'student-laptops': {
    en: {
      ...
      description: 'Perfect laptops for students and education',
    },
    de: {
      title: 'Studenten Laptops',
      slug: 'studenten-laptops',
      description: 'Perfekte Laptops fuer Studenten und Bildung',
    },
    fr: {
      title: 'Portables Etudiants',
      slug: 'portables-etudiants',
      description: 'Portables parfaits pour etudiants et education',
    },
  },
  '2-in-1-laptops': {
    en: {
      ...
      slug: '2-in-1-laptops',
      description: 'Convertible laptops with tablet mode',
    },
    de: {
      title: '2-in-1 Laptops',
      slug: '2-in-1-laptops',
      description: 'Konvertierbare Laptops mit Tablet-Modus',
    },
    fr: {
      title: 'Portables 2-en-1',
      slug: 'portables-2-en-1',
      description: 'Portables convertibles avec mode tablette',
    },
  },
  desktops: {
    en: {
    ...
    de: {
      ...
      description: 'Leistungsstarke Desktop-Computer fuer Zuhause und Buero',
    },
    fr: {
      title: 'Ordinateurs de Bureau',
      slug: 'ordinateurs-bureau',
      description: 'Ordinateurs de bureau puissants pour la maison et le bureau',
    },
  },
  'gaming-desktops': {
    en: {
      ...
      description: 'High-end gaming PCs for ultimate performance',
    },
    de: {
      title: 'Gaming Desktops',
      slug: 'gaming-desktops',
      description: 'High-End Gaming-PCs fuer ultimative Leistung',
    },
    fr: {
      title: 'PC Gaming',
      slug: 'pc-gaming',
      description: 'PC gaming haut de gamme pour des performances ultimes',
    },
  },
  'workstation-desktops': {
    en: {
      title: 'Workstation Desktops',
    ...
    de: {
      title: 'Workstation Desktops',
      slug: 'workstation-desktops',
      description: 'Professionelle Workstations fuer anspruchsvolle Aufgaben',
    },
    fr: {
      title: 'Workstations',
      slug: 'workstations',
      description: 'Stations de travail professionnelles pour taches exigeantes',
    },
  },
  'mini-pcs': {
    en: {
      title: 'Mini PCs',
      slug: 'mini-pcs',
      description: 'Compact desktop computers that save space',
    },
    de: {
      title: 'Mini PCs',
      slug: 'mini-pcs',
      description: 'Kompakte Desktop-Computer die Platz sparen',
    },
    fr: {
      title: 'Mini PC',
      slug: 'mini-pc',
      description: 'Ordinateurs de bureau compacts pour gagner de la place',
    },
  },
  'all-in-ones': {
    en: {
      ...
      slug: 'all-in-ones',
      description: 'Complete computer systems with integrated display',
    },
    de: {
      title: 'All-in-One PCs',
      slug: 'all-in-one-pcs',
      description: 'Komplette Computersysteme mit integriertem Display',
    },
    fr: {
      title: 'PC Tout-en-un',
      slug: 'pc-tout-en-un',
      description: 'Systemes informatiques complets avec ecran integre',
    },
  },
  'computer-accessories': {
    ...
    de: {
      ...
      description: 'Wesentliche Peripheriegeraete und Zubehoer',
    },
    fr: {
      title: 'Accessoires Informatiques',
      slug: 'accessoires-informatiques',
      description: 'Peripheriques et accessoires essentiels',
    },
  },
  keyboards: {
  ...
  'usb-hubs': {
    ...
    de: {
      title: 'USB Hubs',
      slug: 'usb-hubs',
      description: 'Erweitern Sie Ihre Anschlussmoeglichkeiten',
    },
  ...
  'laptop-stands': {
    en: {
      title: 'Laptop Stands',
      slug: 'laptop-stands',
      description: 'Ergonomic laptop stands for better posture',
    },
    de: {
      title: 'Laptop Staender',
      slug: 'laptop-staender',
      description: 'Ergonomische Laptop-Staender fuer bessere Haltung',
    },
    fr: {
      title: 'Supports Laptop',
      slug: 'supports-laptop',
      description: 'Supports ergonomiques pour une meilleure posture',
    },
  },
  'docking-stations': {
    en: {
    ...
    de: {
      title: 'Docking Stations',
      slug: 'docking-stations',
      description: 'Verbinden Sie alle Peripheriegeraete einfach',
    },
    fr: {
      title: 'Stations dAccueil',
      slug: 'stations-accueil',
      description: 'Connectez tous vos peripheriques facilement',
    },
  },
  'laptop-bags': {
    en: {
      title: 'Laptop Bags',
      slug: 'laptop-bags',
      description: 'Protective bags and backpacks for laptops',
    },
    de: {
      title: 'Laptop Taschen',
      slug: 'laptop-taschen',
      description: 'Schutztaschen und Rucksaecke fuer Laptops',
    },
    fr: {
      title: 'Sacs Laptop',
      slug: 'sacs-laptop',
      description: 'Sacs et sacs a dos de protection pour portables',
    },
  },
  'monitors-displays': {
    en: {
      ...
      description: 'Computer monitors for every use case',
    },
    de: {
      title: 'Monitore & Displays',
      slug: 'monitore-displays',
      description: 'Computer-Monitore fuer jeden Anwendungsfall',
    },
    fr: {
      title: 'Moniteurs & Ecrans',
      slug: 'moniteurs-ecrans',
      description: 'Moniteurs informatiques pour chaque usage',
    },
  },
  'gaming-monitors': {
    en: {
    ...
    de: {
      ...
      slug: 'gaming-monitore',
      description: 'Gaming-Bildschirme mit hoher Bildwiederholrate',
    },
  ...
  'professional-monitors': {
    en: {
      ...
      description: 'Color-accurate monitors for professionals',
    },
    de: {
      title: 'Professionelle Monitore',
      slug: 'professionelle-monitore',
      description: 'Farbgenaue Monitore fuer Profis',
    },
    fr: {
      title: 'Moniteurs Professionnels',
      slug: 'moniteurs-professionnels',
      description: 'Moniteurs precis en couleurs pour professionnels',
    },
  },
  'ultrawide-monitors': {
    en: {
      ...
      description: 'Extra-wide screens for immersive viewing',
    },
    de: {
      title: 'Ultrawide Monitore',
      slug: 'ultrawide-monitore',
      description: 'Extra breite Bildschirme fuer immersives Betrachten',
    },
    fr: {
      title: 'Moniteurs Ultrawide',
      slug: 'moniteurs-ultrawide',
      description: 'Ecrans extra-larges pour une vue immersive',
    },
  },
  'portable-monitors': {
    en: {
      ...
      description: 'Take your screen anywhere',
    },
    de: {
      title: 'Tragbare Monitore',
      slug: 'tragbare-monitore',
      description: 'Nehmen Sie Ihren Bildschirm ueberall mit',
    },
    fr: {
      title: 'Moniteurs Portables',
      slug: 'moniteurs-portables',
      description: 'Emportez votre ecran partout',
    },
  },
  ...
  'smartphones-tablets': {
    en: {
      ...
      description: 'Mobile devices for communication and entertainment',
    },
    de: {
      title: 'Smartphones & Tablets',
      slug: 'smartphones-tablets',
      description: 'Mobile Geraete fuer Kommunikation und Unterhaltung',
    },
    fr: {
      title: 'Smartphones & Tablettes',
      slug: 'smartphones-tablettes',
      description: 'Appareils mobiles pour communication et divertissement',
    },
  },
  smartphones: {
    en: {
    ...
    de: {
      title: 'Smartphones',
      slug: 'smartphones',
      description: 'Die neuesten Smartphones von Top-Marken',
    },
    fr: {
      title: 'Smartphones',
      slug: 'smartphones',
  ...
  'android-phones': {
    ...
    de: {
      title: 'Android Handys',
      slug: 'android-handys',
      description: 'Android-betriebene Smartphones',
    },
    fr: {
      title: 'Telephones Android',
      slug: 'telephones-android',
      description: 'Smartphones sous Android',
    },
  },
  iphones: {
  ...
  'flagship-phones': {
    ...
    de: {
      title: 'Flagship Handys',
      slug: 'flagship-handys',
      description: 'Premium-Smartphones mit modernsten Funktionen',
    },
    fr: {
      title: 'Telephones Haut de Gamme',
      slug: 'telephones-haut-gamme',
      description: 'Smartphones premium avec fonctionnalites de pointe',
    },
  },
  'budget-phones': {
    en: {
      title: 'Budget Phones',
      slug: 'budget-phones',
      description: 'Affordable smartphones that deliver',
    },
    de: {
      title: 'Guenstige Handys',
      slug: 'guenstige-handys',
      description: 'Erschwingliche Smartphones die ueberzeugen',
    },
    fr: {
      title: 'Telephones Budget',
      slug: 'telephones-budget',
      description: 'Smartphones abordables qui tiennent leurs promesses',
    },
  },
  'rugged-phones': {
    en: {
      title: 'Rugged Phones',
      slug: 'rugged-phones',
      description: 'Tough smartphones for extreme conditions',
    },
    de: {
      title: 'Robuste Handys',
      slug: 'robuste-handys',
      description: 'Robuste Smartphones fuer extreme Bedingungen',
    },
    fr: {
      title: 'Telephones Robustes',
      slug: 'telephones-robustes',
      description: 'Smartphones resistants pour conditions extremes',
    },
  },
  tablets: {
  ...
  'android-tablets': {
    en: {
      ...
      description: 'Versatile Android-powered tablets',
    },
    de: {
      title: 'Android Tablets',
      slug: 'android-tablets',
      description: 'Vielseitige Android-betriebene Tablets',
    },
    fr: {
      title: 'Tablettes Android',
      slug: 'tablettes-android',
      description: 'Tablettes polyvalentes sous Android',
    },
  },
  ipads: {
  ...
  'e-readers': {
    ...
    de: {
      title: 'E-Reader',
      slug: 'e-reader',
      description: 'Digitale Buchleser fuer begeisterte Leser',
    },
  ...
  'kids-tablets': {
    en: {
      title: 'Kids Tablets',
      slug: 'kids-tablets',
      description: 'Child-friendly tablets with parental controls',
    },
    de: {
      title: 'Kinder Tablets',
      slug: 'kinder-tablets',
      description: 'Kinderfreundliche Tablets mit Elternkontrolle',
    },
    fr: {
      title: 'Tablettes Enfants',
      slug: 'tablettes-enfants',
      description: 'Tablettes adaptees aux enfants avec controle parental',
    },
  },
  'phone-accessories': {
    en: {
    ...
    de: {
      title: 'Handy Zubehoer',
      slug: 'handy-zubehoer',
      description: 'Huellen, Ladegeraete und mehr',
    },
    fr: {
      title: 'Accessoires Telephone',
      slug: 'accessoires-telephone',
      description: 'Coques, chargeurs et plus',
    },
  },
  cases: {
    ...
    fr: {
      title: 'Coques Telephone',
      slug: 'coques-telephone',
      description: 'Coques de protection pour smartphones',
    },
  },
  chargers: {
    en: {
    ...
    de: {
      title: 'Ladegeraete & Kabel',
      slug: 'ladegeraete-kabel',
      description: 'Schnellladegeraete und Qualitaetskabel',
    },
    fr: {
      title: 'Chargeurs & Cables',
      slug: 'chargeurs-cables',
      description: 'Chargeurs rapides et cables de qualite',
    },
  },
  'screen-protectors': {
    en: {
    ...
    fr: {
      title: 'Protecteurs Ecran',
      slug: 'protecteurs-ecran',
      description: 'Verre trempe et films protecteurs',
    },
  },
  'power-banks': {
    en: {
      title: 'Power Banks',
      slug: 'power-banks',
      description: 'Portable chargers for on-the-go power',
    },
    ...
    fr: {
      ...
      description: 'Chargeurs portables pour energie mobile',
    },
  },
  'phone-mounts': {
    en: {
      title: 'Phone Mounts',
      slug: 'phone-mounts',
      description: 'Car and desk mounts for smartphones',
    },
    de: {
      title: 'Handy Halterungen',
      slug: 'handy-halterungen',
      description: 'Auto- und Tischhalterungen fuer Smartphones',
    },
    fr: {
      title: 'Supports Telephone',
      slug: 'supports-telephone',
      description: 'Supports voiture et bureau pour smartphones',
    },
  },
  'tablet-accessories': {
    en: {
      ...
      description: 'Enhance your tablet experience',
    },
    de: {
      title: 'Tablet Zubehoer',
      slug: 'tablet-zubehoer',
      description: 'Verbessern Sie Ihr Tablet-Erlebnis',
    },
    fr: {
      title: 'Accessoires Tablette',
      slug: 'accessoires-tablette',
      description: 'Ameliorez votre experience tablette',
    },
  },
  'tablet-cases': {
    ...
    fr: {
      title: 'Coques Tablette',
      slug: 'coques-tablette',
      description: 'Protection pour votre tablette',
    },
  },
  'stylus-pens': {
    ...
    de: {
      title: 'Stylus Stifte',
      slug: 'stylus-stifte',
      description: 'Digitale Stifte fuer praezise Eingabe',
    },
  ...
  'tablet-keyboards': {
    ...
    de: {
      title: 'Tablet Tastaturen',
      slug: 'tablet-tastaturen',
      description: 'Verwandeln Sie Ihr Tablet in einen Laptop',
    },
    fr: {
      title: 'Claviers Tablette',
      slug: 'claviers-tablette',
      description: 'Transformez votre tablette en laptop',
    },
  },
  ...
  'audio-video': {
    en: {
      title: 'Audio & Video',
      slug: 'audio-video',
      description: 'Headphones, speakers, and home entertainment',
    },
    de: {
      title: 'Audio & Video',
      slug: 'audio-video',
      description: 'Kopfhoerer, Lautsprecher und Heimunterhaltung',
    },
    fr: {
      title: 'Audio & Video',
      slug: 'audio-video',
      description: 'Casques, enceintes et divertissement',
    },
  },
  headphones: {
  ...
  'wireless-headphones': {
    ...
    de: {
      title: 'Kabellose Kopfhoerer',
      slug: 'kabellose-kopfhoerer',
      description: 'Bluetooth Kopfhoerer und Ohrhoerer',
    },
    fr: {
      title: 'Casques Sans Fil',
      slug: 'casques-sans-fil',
      description: 'Casques et ecouteurs Bluetooth',
    },
  },
  'wired-headphones': {
    en: {
      ...
      description: 'Studio and hi-fi wired headphones',
    },
    de: {
      title: 'Kabelgebundene Kopfhoerer',
      slug: 'kabelgebundene-kopfhoerer',
      description: 'Studio und Hi-Fi Kopfhoerer mit Kabel',
    },
    fr: {
      title: 'Casques Filaires',
      slug: 'casques-filaires',
      description: 'Casques studio et hi-fi filaires',
    },
  },
  'gaming-headsets': {
    en: {
    ...
    de: {
      title: 'Gaming Headsets',
      slug: 'gaming-headsets',
      description: 'Immersiver Gaming-Sound mit Mikrofon',
    },
    fr: {
      title: 'Casques Gaming',
      slug: 'casques-gaming',
      description: 'Audio gaming immersif avec microphone',
    },
  },
  'noise-cancelling': {
    en: {
    ...
    de: {
      title: 'Noise Cancelling',
      slug: 'noise-cancelling',
      description: 'Kopfhoerer mit aktiver Gerauschunterdrueckung',
    },
    fr: {
      title: 'Reduction de Bruit',
      slug: 'reduction-bruit',
      description: 'Casques a reduction de bruit active',
    },
  },
  earbuds: {
    ...
    fr: {
      title: 'Ecouteurs',
      slug: 'ecouteurs',
      description: 'Ecouteurs true wireless et intra-auriculaires',
    },
  },
  'sports-headphones': {
    en: {
      ...
      description: 'Sweat-proof headphones for athletes',
    },
    de: {
      title: 'Sport Kopfhoerer',
      slug: 'sport-kopfhoerer',
      description: 'Schweissfeste Kopfhoerer fuer Sportler',
    },
    fr: {
      title: 'Casques Sport',
      slug: 'casques-sport',
      description: 'Casques anti-transpiration pour sportifs',
    },
  },
  speakers: {
  ...
  'bluetooth-speakers': {
    ...
    de: {
      ...
      slug: 'bluetooth-lautsprecher',
      description: 'Kabellose Bluetooth Lautsprecher',
    },
    fr: {
      title: 'Enceintes Bluetooth',
      slug: 'enceintes-bluetooth',
      description: 'Enceintes sans fil Bluetooth',
    },
  },
  'smart-speakers': {
    en: {
    ...
    de: {
      title: 'Smart Lautsprecher',
      slug: 'smart-lautsprecher',
      description: 'Sprachgesteuerte Smart Lautsprecher',
    },
    fr: {
      title: 'Enceintes Intelligentes',
      slug: 'enceintes-intelligentes',
      description: 'Enceintes a commande vocale',
    },
  },
  soundbars: {
    ...
    de: {
      title: 'Soundbars',
      slug: 'soundbars',
      description: 'Elegante Soundbars fuer Ihren Fernseher',
    },
    fr: {
      title: 'Barres de Son',
      slug: 'barres-son',
      description: 'Barres de son elegantes pour votre TV',
    },
  },
  'portable-speakers': {
    en: {
    ...
    de: {
      ...
      slug: 'tragbare-lautsprecher',
      description: 'Nehmen Sie Ihre Musik ueberall mit',
    },
    fr: {
      title: 'Enceintes Portables',
      slug: 'enceintes-portables',
      description: 'Emportez votre musique partout',
    },
  },
  'party-speakers': {
    en: {
      ...
      slug: 'party-speakers',
      description: 'High-power speakers for events',
    },
    de: {
      title: 'Party Lautsprecher',
      slug: 'party-lautsprecher',
      description: 'Hochleistungs-Lautsprecher fuer Events',
    },
    fr: {
      title: 'Enceintes de Fete',
      slug: 'enceintes-fete',
      description: 'Enceintes haute puissance pour evenements',
    },
  },
  'home-theater': {
  ...
  microphones: {
    en: {
      title: 'Microphones',
      slug: 'microphones',
      description: 'Professional microphones for every purpose',
    },
    de: {
      title: 'Mikrofone',
      slug: 'mikrofone',
      description: 'Professionelle Mikrofone fuer jeden Zweck',
    },
    fr: {
      title: 'Microphones',
      slug: 'microphones',
      description: 'Microphones professionnels pour tous usages',
    },
  },
  turntables: {
    ...
    de: {
      ...
      slug: 'plattenspieler',
      description: 'Vinyl-Plattenspieler fuer Audiophile',
    },
    fr: {
      title: 'Platines Vinyles',
      slug: 'platines-vinyles',
      description: 'Platines vinyles pour audiophiles',
    },
  },
  ...
  wearables: {
    ...
    fr: {
      ...
      description: 'Montres connectees et trackers fitness',
    },
  },
  smartwatches: {
    en: {
      title: 'Smartwatches',
      slug: 'smartwatches',
      description: 'Smart timepieces with advanced features',
    },
    de: {
      title: 'Smartwatches',
      slug: 'smartwatches',
      description: 'Intelligente Uhren mit erweiterten Funktionen',
    },
    fr: {
      title: 'Montres Connectees',
      slug: 'montres-connectees',
      description: 'Montres intelligentes avec fonctions avancees',
    },
  },
  'apple-watch': {
  ...
  'android-watches': {
    en: {
      ...
      slug: 'android-watches',
      description: 'Wear OS and Android smartwatches',
    },
    de: {
      title: 'Android Uhren',
      slug: 'android-uhren',
      description: 'Wear OS und Android Smartwatches',
    },
    fr: {
      title: 'Montres Android',
      slug: 'montres-android',
      description: 'Montres connectees Wear OS et Android',
    },
  },
  'hybrid-watches': {
    en: {
      ...
      slug: 'hybrid-watches',
      description: 'Classic looks with smart features',
    },
    de: {
      title: 'Hybrid Uhren',
      slug: 'hybrid-uhren',
      description: 'Klassisches Aussehen mit smarten Funktionen',
    },
    fr: {
      title: 'Montres Hybrides',
      slug: 'montres-hybrides',
      description: 'Look classique avec fonctions connectees',
    },
  },
  'fitness-trackers': {
    en: {
      ...
      description: 'Activity and health monitoring bands',
    },
    de: {
      title: 'Fitness Tracker',
      slug: 'fitness-tracker',
      description: 'Aktivitaets- und Gesundheits-Tracking-Baender',
    },
    fr: {
      title: 'Bracelets Fitness',
      slug: 'bracelets-fitness',
      description: 'Bracelets de suivi activite et sante',
    },
  },
  'smart-rings': {
    en: {
    ...
    de: {
      title: 'Smart Ringe',
      slug: 'smart-ringe',
      description: 'Diskretes Gesundheits- und Fitness-Tracking',
    },
    fr: {
      title: 'Bagues Connectees',
      slug: 'bagues-connectees',
      description: 'Suivi sante et fitness discret',
    },
  },
  'smart-glasses': {
    ...
    fr: {
      title: 'Lunettes Connectees',
      slug: 'lunettes-connectees',
      description: 'Lunettes intelligentes avec RA',
    },
  },
  ...
  consoles: {
    ...
    fr: {
      ...
      slug: 'consoles-jeux',
      description: 'Les dernieres consoles de jeux',
    },
  },
  playstation: {
    en: {
    ...
    de: {
      title: 'PlayStation',
      slug: 'playstation',
      description: 'Sony PlayStation Konsolen und Spiele',
    },
  ...
  'handheld-consoles': {
    ...
    fr: {
      title: 'Consoles Portables',
      slug: 'consoles-portables',
      description: 'Appareils de jeu portables',
    },
  },
  'gaming-accessories': {
    en: {
      ...
      description: 'Controllers, stands, and more',
    },
    de: {
      title: 'Gaming Zubehoer',
      slug: 'gaming-zubehoer',
      description: 'Controller, Staender und mehr',
    },
    fr: {
      title: 'Accessoires Gaming',
      slug: 'accessoires-gaming',
      description: 'Manettes, supports et plus',
    },
  },
  controllers: {
  ...
  'gaming-keyboards': {
    ...
    de: {
      ...
      slug: 'gaming-tastaturen',
      description: 'Mechanische Gaming-Tastaturen',
    },
  ...
  'gaming-chairs': {
    ...
    de: {
      title: 'Gaming Stuehle',
      slug: 'gaming-stuehle',
      description: 'Ergonomische Stuehle fuer Gamer',
    },
    fr: {
      title: 'Chaises Gaming',
      slug: 'chaises-gaming',
      description: 'Chaises ergonomiques pour gamers',
    },
  },
  'gaming-furniture': {
    en: {
      ...
      description: 'Desks and furniture for your gaming setup',
    },
    de: {
      title: 'Gaming Moebel',
      slug: 'gaming-moebel',
      description: 'Tische und Moebel fuer Ihr Gaming-Setup',
    },
    fr: {
      title: 'Mobilier Gaming',
      slug: 'mobilier-gaming',
      description: 'Bureaux et mobilier pour votre setup gaming',
    },
  },
  'vr-gaming': {
    en: {
    ...
    fr: {
      title: 'VR Gaming',
      slug: 'vr-gaming',
      description: 'Casques et accessoires de realite virtuelle',
    },
  },
  ...
  'home-office': {
    ...
    de: {
      title: 'Home Office',
      slug: 'home-office',
      description: 'Alles fuer Ihren Arbeitsplatz zu Hause',
    },
    fr: {
      title: 'Bureau a Domicile',
      slug: 'bureau-domicile',
      description: 'Tout pour votre espace de travail',
    },
  },
  printers: {
  ...
  'inkjet-printers': {
    en: {
      ...
      description: 'Versatile inkjet printers for home and office',
    },
    de: {
      title: 'Tintenstrahldrucker',
      slug: 'tintenstrahldrucker',
      description: 'Vielseitige Tintenstrahldrucker fuer Zuhause und Buero',
    },
    fr: {
      title: 'Imprimantes Jet dEncre',
      slug: 'imprimantes-jet-encre',
      description: 'Imprimantes jet dencre polyvalentes',
    },
  },
  'laser-printers': {
    en: {
      ...
      slug: 'laser-printers',
      description: 'Fast and efficient laser printing',
    },
    de: {
      title: 'Laserdrucker',
      slug: 'laserdrucker',
      description: 'Schneller und effizienter Laserdruck',
    },
    fr: {
      title: 'Imprimantes Laser',
      slug: 'imprimantes-laser',
      description: 'Impression laser rapide et efficace',
    },
  },
  'photo-printers': {
    en: {
      ...
      slug: 'photo-printers',
      description: 'High-quality photo printing at home',
    },
    de: { title: 'Fotodrucker', slug: 'fotodrucker', description: 'Hochwertiger Fotodruck zu Hause' },
    fr: {
      title: 'Imprimantes Photo',
      slug: 'imprimantes-photo',
      description: 'Impression photo haute qualite a domicile',
    },
  },
  'label-printers': {
    ...
    de: {
      ...
      description: 'Drucken Sie Etiketten und Aufkleber',
    },
    fr: {
      title: 'Imprimantes Etiquettes',
      slug: 'imprimantes-etiquettes',
      description: 'Imprimez etiquettes et autocollants',
    },
  },
  routers: {
    en: {
    ...
    de: {
      ...
      slug: 'router-netzwerk',
      description: 'WLAN-Router und Mesh-Systeme',
    },
    fr: {
      title: 'Routeurs & Reseau',
      slug: 'routeurs-reseau',
      description: 'Routeurs WiFi et systemes mesh',
    },
  },
  storage: {
    en: { title: 'Storage Devices', slug: 'storage-devices', description: 'External drives and memory' },
    de: {
      title: 'Speichergeraete',
      slug: 'speichergeraete',
      description: 'Externe Laufwerke und Speicher',
    },
  ...
  'external-drives': {
    en: {
      ...
      slug: 'external-drives',
      description: 'Portable external hard drives and SSDs',
    },
    de: {
      title: 'Externe Festplatten',
      slug: 'externe-festplatten',
      description: 'Tragbare externe Festplatten und SSDs',
    },
    fr: {
      title: 'Disques Externes',
      slug: 'disques-externes',
      description: 'Disques durs externes et SSD portables',
    },
  },
  'usb-drives': {
  ...
  'office-accessories': {
    ...
    de: {
      title: 'Buerozubehoer',
      slug: 'buerozubehoer',
      description: 'Wesentliche Bueroutensilien und Zubehoer',
    },
    fr: {
      title: 'Accessoires Bureau',
      slug: 'accessoires-bureau',
      description: 'Fournitures et accessoires de bureau essentiels',
    },
  },
  presentation: {
    en: {
      title: 'Presentation',
      slug: 'presentation',
      description: 'Projectors and presentation tools',
    },
    de: {
      title: 'Praesentation',
      slug: 'praesentation',
      description: 'Projektoren und Praesentationswerkzeuge',
    },
    fr: {
      title: 'Presentation',
      slug: 'presentation',
      description: 'Projecteurs et outils de presentation',
    },
  },
  ...
  cameras: {
    ...
    fr: {
      ...
      description: 'Appareils photo numeriques et action',
    },
  },
  'digital-cameras': {
    en: {
    ...
    de: {
      ...
      slug: 'digitalkameras',
      description: 'Spiegelreflex- und spiegellose Kameras',
    },
    fr: {
      title: 'Appareils Numeriques',
      slug: 'appareils-numeriques',
      description: 'Reflex et hybrides numeriques',
    },
  },
  'dslr-cameras': {
    ...
    de: {
      title: 'DSLR Kameras',
      slug: 'dslr-kameras',
      description: 'Professionelle digitale Spiegelreflexkameras',
    },
    fr: {
      title: 'Reflex Numeriques',
      slug: 'reflex-numeriques',
      description: 'Appareils reflex numeriques professionnels',
    },
  },
  'mirrorless-cameras': {
    en: {
      ...
      description: 'Compact mirrorless system cameras',
    },
    de: {
      title: 'Spiegellose Kameras',
      slug: 'spiegellose-kameras',
      description: 'Kompakte spiegellose Systemkameras',
    },
  ...
  'compact-cameras': {
    en: {
      ...
      description: 'Easy-to-use point-and-shoot cameras',
    },
    de: {
      title: 'Kompaktkameras',
      slug: 'kompaktkameras',
      description: 'Einfach zu bedienende Kompaktkameras',
    },
  ...
  'instant-cameras': {
    ...
    de: {
      ...
      slug: 'sofortbildkameras',
      description: 'Drucken Sie Fotos sofort',
    },
    fr: {
      title: 'Appareils Instantanes',
      slug: 'appareils-instantanes',
      description: 'Imprimez vos photos instantanement',
    },
  },
  'action-cameras': {
    en: {
      ...
      slug: 'action-cameras',
      description: 'Compact cameras for adventure',
    },
    de: {
      title: 'Action Kameras',
      slug: 'action-kameras',
      description: 'Kompaktkameras fuer Abenteuer',
    },
    fr: {
      title: 'Cameras Action',
      slug: 'cameras-action',
      description: 'Cameras compactes pour laventure',
    },
  },
  'camera-accessories': {
    en: {
      ...
      description: 'Tripods, bags, and lenses',
    },
    de: {
      title: 'Kamera Zubehoer',
      slug: 'kamera-zubehoer',
      description: 'Stative, Taschen und Objektive',
    },
    fr: {
      title: 'Accessoires Photo',
      slug: 'accessoires-photo',
      description: 'Trepied, sacs et objectifs',
    },
  },
  'camera-lenses': {
    en: {
      title: 'Camera Lenses',
      slug: 'camera-lenses',
      description: 'Interchangeable lenses for every shot',
    },
    de: { title: 'Objektive', slug: 'objektive', description: 'Wechselobjektive fuer jede Aufnahme' },
    fr: {
      title: 'Objectifs',
      slug: 'objectifs',
      description: 'Objectifs interchangeables pour chaque prise',
    },
  },
  tripods: {
  ...
  'camera-bags': {
    ...
    de: {
      title: 'Kamerataschen',
      slug: 'kamerataschen',
      description: 'Schutztaschen fuer Ihre Ausruestung',
    },
    fr: {
      title: 'Sacs Photo',
      slug: 'sacs-photo',
      description: 'Sacs de protection pour votre equipement',
    },
  },
  'filters-accessories': {
    en: {
      ...
      description: 'Lens filters and photo accessories',
    },
    de: {
      title: 'Filter & Zubehoer',
      slug: 'filter-zubehoer',
      description: 'Objektivfilter und Fotozubehoer',
    },
    fr: {
      title: 'Filtres & Accessoires',
      slug: 'filtres-accessoires',
      description: 'Filtres objectifs et accessoires photo',
    },
  },
  drones: {
  ...
  'security-cameras': {
    en: {
      ...
      description: 'Home and business security cameras',
    },
    de: {
      title: 'Sicherheitskameras',
      slug: 'sicherheitskameras',
      description: 'Sicherheitskameras fuer Zuhause und Geschaeft',
    },
    fr: {
      title: 'Cameras de Securite',
      slug: 'cameras-securite',
      description: 'Cameras de securite maison et entreprise',
    },
  },
  ...
  'smart-home': {
    ...
    de: {
      title: 'Smart Home',
      slug: 'smart-home',
      description: 'Automatisieren und steuern Sie Ihr Zuhause',
    },
    fr: {
      title: 'Maison Connectee',
      slug: 'maison-connectee',
      description: 'Automatisez et controlez votre maison',
    },
  },
  'smart-lighting': {
    en: {
      ...
      slug: 'smart-lighting',
      description: 'Connected light bulbs and systems',
    },
    de: {
      title: 'Intelligente Beleuchtung',
      slug: 'intelligente-beleuchtung',
      description: 'Vernetzte Gluehbirnen und Systeme',
    },
    fr: {
      title: 'Eclairage Connecte',
      slug: 'eclairage-connecte',
      description: 'Ampoules et systemes connectes',
    },
  },
  'smart-security': {
    ...
    de: {
      ...
      slug: 'intelligente-sicherheit',
      description: 'Vernetzte Sicherheitssysteme',
    },
    fr: {
      title: 'Securite Connectee',
      slug: 'securite-connectee',
      description: 'Systemes de securite connectes',
    },
  },
  'smart-thermostats': {
    en: {
    ...
    de: {
      title: 'Intelligente Thermostate',
      slug: 'intelligente-thermostate',
      description: 'Intelligente Klimasteuerung',
    },
    fr: {
      title: 'Thermostats Connectes',
      slug: 'thermostats-connectes',
      description: 'Controle climatique intelligent',
    },
  },
  'smart-plugs': {
    en: { title: 'Smart Plugs', slug: 'smart-plugs', description: 'Control any device remotely' },
    de: {
      title: 'Intelligente Steckdosen',
      slug: 'intelligente-steckdosen',
      description: 'Steuern Sie jedes Geraet aus der Ferne',
    },
    fr: {
      title: 'Prises Connectees',
      slug: 'prises-connectees',
      description: 'Controlez nimporte quel appareil a distance',
    },
  },
  'voice-assistants': {
    en: {
      ...
      description: 'Smart speakers with voice control',
    },
    de: {
      title: 'Sprachassistenten',
      slug: 'sprachassistenten',
      description: 'Smart Lautsprecher mit Sprachsteuerung',
    },
    fr: {
      title: 'Assistants Vocaux',
      slug: 'assistants-vocaux',
      description: 'Enceintes intelligentes a commande vocale',
    },
  },
  ...
  'wifi-routers': {
    ...
    fr: {
      title: 'Routeurs WiFi',
      slug: 'routeurs-wifi',
      description: 'Routeurs sans fil haute vitesse',
    },
  },
  'mesh-systems': {
    ...
    de: {
      title: 'Mesh Systeme',
      slug: 'mesh-systeme',
      description: 'WLAN-Abdeckung fuer das ganze Haus',
    },
    fr: {
      title: 'Systemes Mesh',
      slug: 'systemes-mesh',
      description: 'Couverture WiFi pour toute la maison',
    },
  },
  'network-switches': {
    en: {
      ...
      description: 'Ethernet switches for wired networks',
    },
    de: {
      title: 'Netzwerk Switches',
      slug: 'netzwerk-switches',
      description: 'Ethernet-Switches fuer kabelgebundene Netzwerke',
    },
    fr: {
      title: 'Switches Reseau',
      slug: 'switches-reseau',
      description: 'Switches Ethernet pour reseaux cables',
    },
  },
  'network-cables': {
  ...
  'access-points': {
    ...
    de: {
      title: 'Access Points',
      slug: 'access-points',
      description: 'Erweitern Sie Ihr drahtloses Netzwerk',
    },
  ...
  'graphics-cards': {
    ...
    de: {
      title: 'Grafikkarten',
      slug: 'grafikkarten',
      description: 'GPUs fuer Gaming und Content-Erstellung',
    },
    fr: {
      title: 'Cartes Graphiques',
      slug: 'cartes-graphiques',
      description: 'GPUs pour gaming et creation de contenu',
    },
  },
  processors: {
  ...
  'ram-memory': {
    ...
    de: {
      ...
      description: 'Systemspeicher fuer bessere Leistung',
    },
    fr: {
      title: 'Memoire RAM',
      slug: 'memoire-ram',
      description: 'Memoire systeme pour meilleures performances',
    },
  },
  ssds: {
  ...
  cooling: {
    ...
    fr: {
      ...
      description: 'Refroidisseurs CPU et ventilateurs boitier',
    },
  },
};
