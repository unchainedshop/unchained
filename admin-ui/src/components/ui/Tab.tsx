    ...
    <div className="mt-10">
      <div className="lg:hidden">
        ...
        <select
          ...
          id="selected-tab"
          name="selected-tab"
          className="mt-1 block dark:bg-slate-800 dark:text-white w-full rounded-md border-border-default py-2 pl-3 pr-10 text-base capitalize focus:outline-none focus:ring-2 focus:ring-slate-800 dark:focus:ring-slate-400 focus:border-slate-800 dark:focus:border-slate-400 sm:text-sm"
          value={currentTab}
        >
          ...
          <nav className="flex flex-wrap gap-3">
            {tabItems.filter(Boolean).map((option) => (
              <a
                ...
                className={clsx(
                  {
                    'cursor-pointer rounded-lg border border-border-default bg-white text-text-primary dark:bg-slate-900 shadow-sm dark:hover:border-slate-500 hover:border-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-800 dark:focus:ring-slate-400 focus:ring-offset-2 dark:focus:ring-offset-slate-900':
