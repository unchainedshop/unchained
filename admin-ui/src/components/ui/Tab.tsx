          ...
          <nav className="flex flex-wrap gap-3">
            {tabItems.filter(Boolean).map((option) => (
              <a
                ...
                className={clsx(
                  {
                    'cursor-pointer rounded-lg border border-border-default bg-white text-text-primary dark:bg-slate-900 shadow-sm dark:hover:border-slate-500 hover:border-slate-400 focus:outline-none focus:ring-2 focus:ring-focus-ring focus:ring-offset-2 dark:focus:ring-offset-slate-900':
