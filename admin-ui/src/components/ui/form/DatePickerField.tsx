  ...
  return (
    <FieldWrapper {...field} className={props.containerClassName}>
      <input
        ...
        className={clsx(
          'relative mt-0 block w-full appearance-none rounded-md rounded-b-md border-1 border-border-default px-4 py-2.5 text-sm text-text-primary dark:bg-slate-900 placeholder-slate-400 shadow-xs focus:z-10  focus:outline-hidden focus:ring-2 focus:ring-slate-800',
          className,
          {
