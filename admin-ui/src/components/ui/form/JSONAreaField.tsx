...
const JSONAreaField = ({
  ...
  return (
    <FieldWrapper {...field}>
      <JSONView
        className={clsx(
          'mt-1 block w-full max-w-full rounded-md border-1 border-border-default dark:bg-slate-900 dark:text-slate-200 shadow-xs dark:shadow-none focus:ring-slate-800 sm:text-sm',
          {
