  ...
  return (
    <FieldWrapper {...field}>
      <div className="select-wrap">
        <select
          className={clsx(
            'block w-full dark:bg-slate-900 dark:text-white rounded-md border-1 border-border-default py-2.5 pl-3 pr-10 text-base text-black shadow-xs  focus:outline-hidden focus:ring-2 focus:ring-slate-800 sm:text-sm',
            className,
            {
