...
const BundleProductsListItem = ({ item, onDelete, index }) => {
  ...
  return (
    <Link href={`/products?slug=${generateUniqueId(product)}`}>
      <div className=" group flex w-full items-center justify-between border-b border-border-subtle hover:border-slate-300 dark:hover:border-slate-600 hover:bg-slate-50/80 dark:hover:bg-slate-700/50 transition-all duration-200 ease-in-out hover:shadow-sm last:border-none">
