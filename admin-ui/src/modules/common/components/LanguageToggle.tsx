...
const LanguageToggle = ({ narrowNav = false }) => {
  ...
  return (
    <div className="relative" data-language-toggle>
      ...
      {isOpen && (
        <div
          className={`absolute w-48 rounded-md shadow-lg bg-surface ring-1 ring-black ring-opacity-5 z-[9999] ${
            narrowNav
        ...
        >
          <div className="py-1" role="menu">
            <div className="px-4 py-2 text-xs font-semibold text-text-muted uppercase tracking-wide border-b border-border-subtle">
              {formatMessage({
                id: 'select_language',
