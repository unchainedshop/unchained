    ...
    <div className="w-100">
      <div className="relative my-2 flex items-start">
        <select
          ...
          name="select-type"
          autoComplete="off"
          className="dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700 w-50 block w-full rounded-md border-slate-300 shadow-xs  focus:ring-focus-ring sm:text-sm"
        >
          <option value="">
            {formatMessage({
              id: 'filter_by_type',
