        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 text-sm border border-border-subtle rounded-lg bg-surface text-text-primary placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-800 dark:focus:ring-slate-400"
            />
          </div>
        </div>
      </div>
