...
export type IAuditLogEntryFragment = { id: string, time: number, message?: string | null, classUid: number, className: string, activityId: number, activityName?: string | null, typeUid: number, categoryUid: number, severityId: number, statusId: number, statusDetail?: string | null, sequenceNumber?: number | null, prevHash?: string | null, hash?: string | null, raw?: any | null, actor?: { user?: { uid?: string | null, name?: string | null, emailAddr?: string | null } | null, session?: { uid?: string | null } | null } | null, srcEndpoint?: { ip?: string | null, port?: number | null } | null, api?: { operation?: string | null, request?: { uid?: string | null } | null, response?: { code?: number | null } | null } | null };
...
export type IAuditChainStatusQuery = { auditChainStatus: { valid: boolean, totalEntries: number, checkedEntries: number, firstEntry?: number | null, lastEntry?: number | null, errors: Array<{ sequenceNumber: number, message: string }> } };
