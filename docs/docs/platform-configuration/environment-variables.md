...
| `UNCHAINED_GUEST_USER_EXPIRY_DAYS` | `30` | Retention window (in days) for inactive guest users before the daily guest garbage-collection worker removes them and their abandoned carts |
