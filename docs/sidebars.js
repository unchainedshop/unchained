...
const sidebars = {
  mainSidebar: [
    // Homepage (hidden from sidebar, but associates it with this sidebar)
    {
      type: 'doc',
      id: 'index',
    ...
    // ── Documentation ──
    {
      ...
      collapsible: true,
      collapsed: false,
      className: 'sidebar-section-header sidebar-section--docs',
      link: {
        type: 'doc',
      ...
      items: [
        ...
        // Platform Configuration
        {
          ...
          items: [
            ...
            'platform-configuration/enable-copilot',
            {
              ...
              items: [{ type: 'autogenerated', dirName: 'platform-configuration/modules' }],
            },
          ],
        },
        ...
        // Extending
        {
          ...
          items: [
            ...
            },
            {
              type: 'category',
              label: 'Catalog',
              items: ['extend/catalog/filter', 'extend/catalog/search-behavior'],
            },
            'extend/events',
            'extend/quotation',
            'extend/enrollment',
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                'plugins/pricing/pricing-product-eu-tax',
                'plugins/pricing/pricing-product-uk-tax',
                'plugins/pricing/pricing-product-us-sales-tax',
                'plugins/pricing/pricing-delivery-free',
                'plugins/pricing/pricing-delivery-swiss-tax',
                'plugins/pricing/pricing-delivery-eu-tax',
                'plugins/pricing/pricing-delivery-uk-tax',
            ...
            },
            {
              ...
              items: [
                ...
                'plugins/warehousing/warehousing-erc-metadata',
              ],
            },
            {
              type: 'category',
              ...
              items: ['plugins/filters/filter-local-search', 'plugins/filters/filter-strict-equal'],
            },
            {
              type: 'category',
              label: 'File Storage',
              ...
              items: [
                ...
                'plugins/files/file-temp-upload',
              ],
            },
            {
              type: 'category',
              ...
              items: [
                ...
                'plugins/workers/worker-bulk-export',
                ...
                'plugins/workers/worker-gc-guests',
                'plugins/workers/worker-invalidate-carts',
            ...
            },
            {
              ...
              items: ['plugins/quotations/quotation-manual'],
            },
            {
              type: 'category',
              label: 'Enrollments',
              link: { type: 'doc', id: 'plugins/enrollments/index' },
              items: ['plugins/enrollments/enrollment-licensed'],
            },
          ],
        },
        ...
        // AI Integration
        {
          ...
          items: ['ai-integration/mcp-server', 'ai-integration/admin-copilot', 'ai-integration/ai-faq'],
        },
    ...
    // ── Guides ──
    {
      ...
      collapsible: true,
      collapsed: true,
      className: 'sidebar-section-header sidebar-section--guides',
      link: {
        type: 'doc',
        id: 'guides/index',
      },
    ...
    // ── Admin UI ──
    {
      ...
      collapsible: true,
      collapsed: true,
      className: 'sidebar-section-header sidebar-section--admin',
      link: {
        type: 'doc',
        id: 'admin-ui/overview',
      },
      items: [
        {
          type: 'autogenerated',
