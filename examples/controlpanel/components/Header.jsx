  ...
  <Menu stackable attached="top" size="tiny" {...rest}>
    <Link href="/" passHref>
      <Menu.Item active={pathname === '/'}>
        <svg height="32px" viewBox="0 0 620 680" xmlns="http://www.w3.org/2000/svg">
...
const Header = ({ pathname, loggedInUser, logout: doLogout, data: { shopInfo }, ...rest }) =>
  loggedInUser ? (
      ...
      <Dropdown item text="System">
        <Dropdown.Menu>
          ...
          <Link href="/warehousing-providers" passHref>
            <Dropdown.Item active={pathname.startsWith('/warehousing-providers')}>
