import { Collection, FindOptions, UpdateFilter } from 'mongodb';
...
export const findPreservingIds =
  ...
  ): ((selector: UpdateFilter<T>, ids: Array<string>, options?: FindOptions) => Promise<Array<T>>) =>
  async (selector: UpdateFilter<T>, ids: Array<string>, options?: FindOptions): Promise<Array<T>> => {
