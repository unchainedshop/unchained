...
export var generateDbMutations = function (collection, schema) {
    ...
    return {
        ...
        update: function (_id, doc, userId) { return __awaiter(void 0, void 0, void 0, function () {
            var values, filter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        checkId(_id);
                        values = schema.clean(doc, { isModifier: true });
