...
Migrations.add({
  ...
  up() {
    Collections.Assortments.rawCollection()
      .dropIndexes()
      .catch(() => {});
    Collections.AssortmentTexts.rawCollection()
      .dropIndexes()
      .catch(() => {});
    Collections.AssortmentProducts.rawCollection()
      .dropIndexes()
      .catch(() => {});
    Collections.AssortmentLinks.rawCollection()
      .dropIndexes()
      .catch(() => {});
    Collections.AssortmentFilters.rawCollection()
      .dropIndexes()
      .catch(() => {});
  },
  down() {},
