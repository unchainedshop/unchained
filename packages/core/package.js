...
Package.onUse((api) => {
  ...
  api.use('unchained:core-assortments@1.0.0-rc.24');
  api.use('unchained:core-bookmarks@1.0.0-rc.24');
  api.use('unchained:core-countries@1.0.0-rc.24');
  api.use('unchained:core-currencies@1.0.0-rc.24');
  api.use('unchained:core-delivery@1.0.0-rc.24');
  api.use('unchained:core-enrollments@1.0.0-rc.24');
  api.use('unchained:core-events@1.0.0-rc.24');
  api.use('unchained:core-files@1.0.0-rc.24');
  api.use('unchained:core-filters@1.0.0-rc.24');
  api.use('unchained:core-languages@1.0.0-rc.24');
  api.use('unchained:core-messaging@1.0.0-rc.24');
  api.use('unchained:core-orders@1.0.0-rc.24');
  api.use('unchained:core-payment@1.0.0-rc.24');
  api.use('unchained:core-products@1.0.0-rc.24');
  api.use('unchained:core-quotations@1.0.0-rc.24');
  api.use('unchained:core-users@1.0.0-rc.24');
  api.use('unchained:core-warehousing@1.0.0-rc.24');
