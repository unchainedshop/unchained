...
Package.onUse((api) => {
  ...
  api.use('unchained:core-accountsjs@1.0.0-rc.11');
  api.use('unchained:core-assortments@1.0.0-rc.11');
  api.use('unchained:core-bookmarks@1.0.0-rc.11');
  api.use('unchained:core-countries@1.0.0-rc.11');
  api.use('unchained:core-currencies@1.0.0-rc.11');
  ...
  api.use('unchained:core-orders@1.0.0-rc.11');
  api.use('unchained:core-payment@1.0.0-rc.11');
  api.use('unchained:core-products@1.0.0-rc.11');
  api.use('unchained:core-quotations@1.0.0-rc.11');
  api.use('unchained:core-users@1.0.0-rc.11');
  api.use('unchained:core-warehousing@1.0.0-rc.11');
  api.use('unchained:core-worker@1.0.0-rc.11');
...
Package.onTest((api) => {
  ...
  api.use('unchained:core@1.0.0-rc.11');
