...
Package.onUse((api) => {
  ...
  api.use('unchained:core-currencies@1.0.0-beta7');
  api.use('unchained:core-countries@1.0.0-beta7');
  api.use('unchained:core-delivery@1.0.0-beta7');
  api.use('unchained:core-discounting@1.0.0-beta7');
  api.use('unchained:core-documents@1.0.0-beta7');
  api.use('unchained:core-languages@1.0.0-beta7');
  api.use('unchained:core-logger@1.0.0-beta7');
  api.use('unchained:core-messaging@1.0.0-beta7');
  api.use('unchained:core-quotations@1.0.0-beta7');
  api.use('unchained:core-orders@1.0.0-beta7');
  api.use('unchained:core-payment@1.0.0-beta7');
  ...
  api.use('unchained:core-bookmarks@1.0.0-beta7');
  api.use('unchained:core-warehousing@1.0.0-beta7');
  api.use('unchained:core-filters@1.0.0-beta7');
  api.use('unchained:core-assortments@1.0.0-beta7');
  api.use('unchained:core-worker@1.0.0-beta7');
  api.use('unchained:core-subscriptions@1.0.0-beta7');
