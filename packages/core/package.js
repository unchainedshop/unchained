...
Package.onUse((api) => {
  ...
  api.use('unchained:core-delivery@1.0.0-beta12');
  api.use('unchained:core-discounting@1.0.0-beta12');
  api.use('unchained:core-documents@1.0.0-beta12');
  api.use('unchained:core-languages@1.0.0-beta12');
  api.use('unchained:core-logger@1.0.0-beta12');
  api.use('unchained:core-messaging@1.0.0-beta12');
  api.use('unchained:core-quotations@1.0.0-beta12');
  api.use('unchained:core-orders@1.0.0-beta12');
  ...
  api.use('unchained:core-users@1.0.0-beta12');
  api.use('unchained:core-accountsjs@1.0.0-beta12');
