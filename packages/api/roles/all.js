...
export default (role, actions) => {
  ...
  role.allow(actions.updateOrderDeliveryPickUp, () => false);
  role.allow(actions.updateOrderDeliveryShipping, () => false);
  role.allow(actions.updateOrderPaymentGeneric, () => false);
  role.allow(actions.updateOrderPaymentInvoice, () => false);
  role.allow(actions.updateOrderPaymentCard, () => false);
