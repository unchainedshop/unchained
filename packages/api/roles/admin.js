export default (role, actions) => {
  ...
  role.allow(actions.updateOrderDeliveryPickUp, () => true);
  role.allow(actions.updateOrderDeliveryShipping, () => true);
  role.allow(actions.updateOrderPaymentGeneric, () => true);
  role.allow(actions.updateOrderPaymentInvoice, () => true);
  role.allow(actions.updateOrderPaymentCard, () => true);
