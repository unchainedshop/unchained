...
Package.describe({
  name: 'unchained:api',
  version: '0.25.0', // eslint-disable-line
...
Package.onUse(api => {
  ...
  api.use('unchained:roles@0.25.0');
  api.use('unchained:core-currencies@0.25.0');
  ...
  api.use('unchained:core-warehousing@0.25.0');
  api.use('unchained:core-filters@0.25.0');
  api.use('unchained:core-assortments@0.25.0');
