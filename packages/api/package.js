...
Package.onUse((api) => {
  ...
  api.use('unchained:roles@0.21.0');
  api.use('unchained:core-currencies@0.21.0');
  ...
  api.use('unchained:core-quotations@0.21.0');
  api.use('unchained:core-orders@0.21.0');
  ...
  api.use('unchained:core-filters@0.21.0');
  api.use('unchained:core-assortments@0.21.0');
