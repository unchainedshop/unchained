...
Package.onUse((api) => {
  ...
  api.use('unchained:roles@0.48.0');
  api.use('unchained:core-currencies@0.48.0');
  api.use('unchained:core-countries@0.48.0');
  api.use('unchained:core-delivery@0.48.0');
  api.use('unchained:core-discounting@0.48.0');
  ...
  api.use('unchained:core-bookmarks@0.48.0');
  api.use('unchained:core-warehousing@0.48.0');
  api.use('unchained:core-filters@0.48.0');
  api.use('unchained:core-assortments@0.48.0');
  api.use('unchained:core-subscriptions@0.48.0');
