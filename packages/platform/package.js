...
Package.onUse((api) => {
  ...
  api.use('unchained:core-currencies@0.53.1');
  ...
  api.use('unchained:core-messaging@0.53.1');
  api.use('unchained:core-quotations@0.53.1');
  api.use('unchained:core-orders@0.53.1');
  ...
  api.use('unchained:core-bookmarks@0.53.1');
  api.use('unchained:core-warehousing@0.53.1');
  api.use('unchained:core-filters@0.53.1');
  api.use('unchained:core-assortments@0.53.1');
  api.use('unchained:core-worker@0.53.1');
  api.use('unchained:core-subscriptions@0.53.1');
  api.use('unchained:api@0.53.1');
