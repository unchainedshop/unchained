...
Package.onUse(api => {
  ...
  api.use('unchained:core@0.38.0');
  api.use('unchained:core-currencies@0.38.0');
  ...
  api.use('unchained:core-languages@0.38.0');
  api.use('unchained:core-logger@0.38.0');
  api.use('unchained:core-messaging@0.38.0');
  api.use('unchained:core-quotations@0.38.0');
  api.use('unchained:core-orders@0.38.0');
  ...
  api.use('unchained:core-bookmarks@0.38.0');
  api.use('unchained:core-warehousing@0.38.0');
  api.use('unchained:core-filters@0.38.0');
  api.use('unchained:core-assortments@0.38.0');
  api.use('unchained:core-worker@0.38.0');
  api.use('unchained:api@0.38.0');
