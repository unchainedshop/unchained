...
Package.onUse((api) => {
  ...
  api.use('unchained:core-messaging@0.55.1');
  api.use('unchained:core-quotations@0.55.1');
  api.use('unchained:core-orders@0.55.1');
  ...
  api.use('unchained:core-accountsjs@0.55.1');
  api.use('unchained:core-bookmarks@0.55.1');
  api.use('unchained:core-warehousing@0.55.1');
  api.use('unchained:core-filters@0.55.1');
  api.use('unchained:core-assortments@0.55.1');
  api.use('unchained:core-worker@0.55.1');
  api.use('unchained:core-subscriptions@0.55.1');
  api.use('unchained:api@0.55.1');
