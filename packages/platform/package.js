...
Package.onUse((api) => {
  ...
  api.use('unchained:core-currencies@0.54.1');
  api.use('unchained:core-countries@0.54.1');
  api.use('unchained:core-delivery@0.54.1');
  api.use('unchained:core-discounting@0.54.1');
  api.use('unchained:core-documents@0.54.1');
  api.use('unchained:core-languages@0.54.1');
  api.use('unchained:core-logger@0.54.1');
  api.use('unchained:core-messaging@0.54.1');
  api.use('unchained:core-quotations@0.54.1');
  api.use('unchained:core-orders@0.54.1');
  ...
  api.use('unchained:core-filters@0.54.1');
  api.use('unchained:core-assortments@0.54.1');
  api.use('unchained:core-worker@0.54.1');
  api.use('unchained:core-subscriptions@0.54.1');
  api.use('unchained:api@0.54.1');
